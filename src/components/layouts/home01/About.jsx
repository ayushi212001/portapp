                ...
                <div className="d-lg-flex">
                    <div className="col-left">
                        <div className="featured-post animate-element wow delay5 fadeInUp" data-wow-delay="0.5s">
                            <img src="images/section/anu.jpg" alt="images"/>
                        </div>
                    </div>
                    <div className="col-right">
                        ...
                        <div className="flat-title t1">
                            <div className="animate-element wow delay5 fadeInDown" data-wow-delay="0.5s">
                                ...
                                <p>
                                Hi, if you need  a landing page or Website design ? then you can tell me, I'm here to help you. I can help you deisgn your website exactly like you wanted it to be. Check my portfolio.
                                </p>
                            </div>
